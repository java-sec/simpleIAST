...
public final class HttpServletRequest extends AbstractRequest {
    ...
    public String getContentType() {
        return ReflectionUtils.invokeStringMethod(request, "getContentType", EMPTY_CLASS);
    }
    ...
    public String getContextPath() {
        return ReflectionUtils.invokeStringMethod(request, "getContextPath", EMPTY_CLASS);
    }
    ...
    public StringBuffer getRequestURL() {
        try {
            Object ret = ReflectionUtils.invokeMethod(request, "getRequestURL", EMPTY_CLASS);
    ...
    public String getParameter(String key) {
        ...
        return ReflectionUtils.invokeStringMethod(request, "getParameter", STRING_CLASS, key);
    }
    ...
    public Enumeration<String> getParameterNames() {
        ...
        Object ret = ReflectionUtils.invokeMethod(request, "getParameterNames", EMPTY_CLASS);
    ...
    public Map<String, String[]> getParameterMap() {
        ...
        if (canGetParameter || setCharacterEncodingFromConfig()) {
            normalMap = (Map<String, String[]>) ReflectionUtils.invokeMethod(request, "getParameterMap", EMPTY_CLASS);
        }
...
//        }
    ...
    public String getCharacterEncoding() {
        String encoding = ReflectionUtils.invokeStringMethod(request, "getCharacterEncoding", EMPTY_CLASS);
...
//            LogTool.traceHookWarn("failed to merge parameter: " + t.getMessage(), t);
    ...
    private String getRealPathForWeblogic() {
        Object servletContext = ReflectionUtils.invokeMethod(request, "getContext", new Class[]{});
